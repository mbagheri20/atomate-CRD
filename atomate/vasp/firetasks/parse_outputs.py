...
class RamanTensorToDb(FiretaskBase):
    ...
    def run_task(self, fw_spec):
        ...
        # To convert the frequency to cm^-1: multiply sqrt(-e_i) by 82.995    # right value is 521.470807261
        # To convert phonopy freq to THZ: multiply sqrt(-e_i) by 98.22462955
        nm_frequencies = np.sqrt(np.abs(nm_eigenvals)) * 521.470807261  # cm^-1
        ...
        d = {
            ...
            "MP_id": fw_spec["normalmodes"]["mpid"]
        }
